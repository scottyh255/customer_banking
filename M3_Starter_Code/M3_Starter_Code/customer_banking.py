...
def main():
    ...
    savings_maturity = float(input("How many months: "))
    ...
    # ADD YOUR CODE HERE
    print(f'Interest earned: {savings_interest_earned:.2f}, and current balance: {updated_savings_balance:.2f}')
    ...
    # ADD YOUR CODE HERE
    print(f'CD interest earned: {cd_interest_earned:.2f}, and cd balance is: {updated_cd_balance:.2f}')
